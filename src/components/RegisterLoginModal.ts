      ...
      <div class="modal-body">
        <form class="was-validated" id="registerForm">
          ...
          <div class="mb-3 position-relative">
              ...
              />
              <i
                class="fa-solid fa-eye-slash password-toggle-icon"
                id="togglePassword"
              ></i>  
              <div class="invalid-feedback">
          ...
          >
            <button
              class="btn btn-outline-dark btn-custom btn-block"
              id="registerButton"
            >
              Registarse
            </button>
            ...
            <button
              class="btn btn-outline-dark btn-custom btn-block visually-hidden"
              id="loginButton"
            >
              Ingresar
            </button>
