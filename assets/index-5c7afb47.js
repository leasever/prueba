      ...
      <tfoot>
        ...
        <div class="container-xxl px-4">
          <nav class="navbar navbar-expand-md navbar-light">
            <div src="img/logo.png" class="w-50 img-thumbnail" alt="Logo dss" ></div>
