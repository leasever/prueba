(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const o of s)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function a(s){const o={};return s.integrity&&(o.integrity=s.integrity),s.referrerPolicy&&(o.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?o.credentials="include":s.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(s){if(s.ep)return;s.ep=!0;const o=a(s);fetch(s.href,o)}})();const D=[{_id:1,name:"Rascador T-4000",image:["img/products/scraper.jpg","img/products/scraperModal1.jpg","img/products/scraperModal2.jpg","img/products/scraperModal3.jpg"],description:"Los gatos tienen un impulso natural de rascarse: la acción les ayuda a eliminar material viejo de sus garras y marcar el territorio con las glándulas olorosas de sus patas.",price:89,rating:4},{_id:2,name:"Headphone Pro",image:["img/products/headphone.jpg","img/products/headphoneModal1.jpg","img/products/headphoneModal2.jpg","img/products/headphoneModal3.jpg"],description:"El Headphone Pro tiene bajos más potentes, mejora la experiencia de audio, proporciona una alta calidad de sonido.",price:150,rating:3.5},{_id:3,name:"Mochila Pet 7000",image:["img/products/mochila.jpg","img/products/mochilaModal1.jpg","img/products/mochilaModal2.jpg","img/products/mochilaModal3.jpg"],description:"Ideal para visitas al veterinario, paseos, viajes, o para llevarla donde quieras!, Incluye varios orificios amplios para ventilación, además de contar con un acrílico que protege a tu mascota.",price:99,rating:4.5}];function T(e,t){localStorage.setItem(e,JSON.stringify(t))}function b(e){const t=localStorage.getItem(e);return t?JSON.parse(t):null}function ee(e,t){sessionStorage.setItem(e,JSON.stringify(t))}function I(e){const t=sessionStorage.getItem(e);return t?JSON.parse(t):null}function J(e){sessionStorage.removeItem(e)}const S=16,z=S,ve=function(e){return btoa(String.fromCharCode(...new Uint8Array(e)))},be=function(e){return Uint8Array.from(atob(e),t=>t.charCodeAt(0))},te=async function(e){const t=new TextEncoder;let a="AES-CBC",n=await window.crypto.subtle.importKey("raw",t.encode(e.password),{name:"PBKDF2"},!1,["deriveKey"]);return await window.crypto.subtle.deriveKey({name:"PBKDF2",salt:t.encode(e.sal.toString()),iterations:e.iterations,hash:e.hash},n,{name:a,length:e.longitude},!1,["encrypt","decrypt"])};async function $(e,t){const a=new TextEncoder,n=window.crypto.getRandomValues(new Uint8Array(16)),s=window.crypto.getRandomValues(new Uint8Array(16)),o=a.encode(t),i=te({password:e,sal:n,iterations:1e5,longitude:256,hash:"SHA-256"}),r=await window.crypto.subtle.encrypt({name:"AES-CBC",iv:s},await i,o);return ve([...n,...s,...new Uint8Array(r)])}async function ae(e,t){const a=new TextDecoder,n=be(t),s=n.slice(0,S),o=n.slice(0+S,S+z),i=te({password:e,sal:s,iterations:1e5,longitude:256,hash:"SHA-256"}),r=await window.crypto.subtle.decrypt({name:"AES-CBC",iv:o},await i,n.slice(S+z));return a.decode(r)}let N;const ge=new Uint8Array(16);function fe(){if(!N&&(N=typeof crypto<"u"&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto),!N))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return N(ge)}const d=[];for(let e=0;e<256;++e)d.push((e+256).toString(16).slice(1));function ye(e,t=0){return d[e[t+0]]+d[e[t+1]]+d[e[t+2]]+d[e[t+3]]+"-"+d[e[t+4]]+d[e[t+5]]+"-"+d[e[t+6]]+d[e[t+7]]+"-"+d[e[t+8]]+d[e[t+9]]+"-"+d[e[t+10]]+d[e[t+11]]+d[e[t+12]]+d[e[t+13]]+d[e[t+14]]+d[e[t+15]]}const he=typeof crypto<"u"&&crypto.randomUUID&&crypto.randomUUID.bind(crypto),G={randomUUID:he};function ne(e,t,a){if(G.randomUUID&&!t&&!e)return G.randomUUID();e=e||{};const n=e.random||(e.rng||fe)();if(n[6]=n[6]&15|64,n[8]=n[8]&63|128,t){a=a||0;for(let s=0;s<16;++s)t[a+s]=n[s];return t}return ye(n)}const xe=new Intl.NumberFormat(void 0,{currency:"USD",style:"currency"});function k(e){return xe.format(e)}function Ee(){return document.getElementById("canvaCard").innerHTML+=`<div
    ...
    </div>`}Ee();const we=D;function Se(e){const t=document.querySelector("#divAccordion");e.purchase.reverse().map((a,n)=>{const s=document.createElement("h2");s.className="accordion-header",s.id="accordion"+n;const o=document.createElement("button");o.className="accordion-button",o.type="button",o.setAttribute("data-bs-toggle","collapse"),o.setAttribute("data-bs-target","#colpase"+n),o.setAttribute("aria-expanded","true"),o.setAttribute("aria-controls","colpase"+n);const c=new Date(a.date).toLocaleDateString("es-ES",{weekday:"short",year:"numeric",month:"long",day:"numeric",hour:"numeric",minute:"numeric"});o.innerText=c;const i=document.createElement("div");i.id="colpase"+n,i.className="accordion-collapse collapse show",i.setAttribute("aria-labelledby","accordion"+n);const r=document.createElement("div");r.className="accordion-body px-1";const m=document.createElement("span");m.className="fw-600",m.innerText="ID: "+a._id;const l=document.createElement("table");l.className="table table-sm table-bordered mt-2",l.innerHTML+=`
    <thead>
       <tr>        
    ...
    `;let g=0;for(let p=0;p<a.items.length;p++){const v=we.find(f=>f._id===a.items[p]._id);g+=a.items[p].quantity*v.price,l.innerHTML+=`          
        <tbody>
          <tr >            
            <td scope="row">
      ...
      </tfoot>`,s.append(o),r.append(m,l),i.append(r),t.append(s),t.append(i)})}const K=document.querySelector("#accordionItems"),Le=b("users");function j(e){K.innerHTML="";const t=document.createElement("div");t.id="divAccordion";const a=document.createElement("div");a.className="card mb-2";const n=document.createElement("div");n.className="card-header d-flex flex-row justify-content-between";const s=document.createElement("p");s.innerText="Hola, "+e.username;const o=document.createElement("a");o.href="#",o.innerText="Cerrar sesión",o.addEventListener("click",p=>{p.preventDefault(),J("user"),location.reload()});const c=document.createElement("ul");c.className="list-group list-group-flush";const i=document.createElement("li");i.className="list-group-item",i.innerText=e.email;const r=document.createElement("li");r.className="list-group-item d-flex flex-row justify-content-between";const m=document.createElement("p");m.innerText="Compras realizadas: "+e.purchase.length;const l=document.createElement("button");l.type="button",l.className="btn btn-danger icon-cart",l.title="Eliminar cuenta";const g=document.createElement("i");g.className="fas fa-trash-alt",l.append(g),l.addEventListener("click",()=>{if(confirm("¿Quieres borrar este perfil y sus datos?")){let p=Le.filter(v=>v.email!==e.email);T("users",p),J("user"),location.reload()}return null}),r.append(m,l),n.append(s,o),a.append(n),a.append(c),c.append(i,r),t.append(a),K.append(t),e.purchase.length>0&&Se(e)}const ke=document.querySelector("#nav-profile-tab");async function Te(){const e=b("carrito"),t=I("user"),a=b("users");t.purchase.push({_id:ne(),date:new Date,items:e}),ee("user",t),ke.click();const n=await ae(t.email,t._id),s=await $(n,JSON.stringify({email:t.email,username:t.username,_id:t._id,purchase:t.purchase})),o=a.map(c=>c.email===t.email?{...c,user:s}:c);qe(o),alert("Gracias por su compra "+t.username),j(t)}function qe(e){const t=document.querySelectorAll(".custom-cart-button");T("users",e),T("carrito",[]),M(),t.forEach(a=>{const n=a.id.replace("addToCartButton","");a.innerHTML=`Añadir <i id="icon${n}" class="fa-solid fa-shopping-cart"></i>`})}function Ne(){return document.getElementById("headerContent").innerHTML+=`<div class="shadow-sm header-stiky" id="myHeader">
      ...
      </div>`}Ne();const C=document.querySelector("#cartContainer"),Q=document.querySelector("#precioTotal"),L=document.querySelector("#btnPay"),W=document.querySelector("#contadorCarrito"),Ce=document.querySelector("#loginRegisterModal"),Ie=D;function Me(e){let t=0,a=0;e.length===0&&(C.innerHTML="",Q.innerText="DSS",L.innerText="Médios de pago",L.classList.add("disabled"),W.innerText="0"),e.map(n=>{const s=Ie.find(pe=>pe._id===n._id);a+=n.quantity,W.innerText=a.toString();const o=document.createElement("div");o.className="d-flex align-items-center gap-2 mb-2";const c=document.createElement("a");c.href="#staticBackdrop"+s._id,c.setAttribute("data-bs-toggle","modal");const i=document.createElement("img");i.src=s.image[0],i.className="img-cart img-thumbnail";const r=document.createElement("div");r.className="d-flex flex-wrap justify-content-between w-100 gap-2 me-auto";const m=document.createElement("div");m.className="me-auto";const l=document.createElement("div");l.innerText=s.name+" ",l.className="justify-content-start ";const g=document.createElement("span");g.className="text-muted quantity-cart",g.innerText="x "+n.quantity.toString();const p=document.createElement("div");p.className="text-muted price-cart",p.innerText=k(s.price).toString();const v=document.createElement("div");v.innerText=k(s.price*n.quantity).toString(),t+=s.price*n.quantity;const f=document.createElement("div");f.className="d-flex flex-wrap gap-1 col-12";const h=document.createElement("button");h.type="button",h.className="btn btn-outline-primary icon-cart",h.addEventListener("click",()=>{De(n._id)});const _=document.createElement("i");_.className="fas fa-minus";const x=document.createElement("button");x.type="button",x.className="btn btn-danger icon-cart",x.addEventListener("click",()=>{confirm("Desea eliminar el producto: "+(s==null?void 0:s.name))&&Ae(n._id)});const F=document.createElement("i");F.className="fas fa-trash-alt";const E=document.createElement("button");E.type="button",E.className="btn btn-outline-primary icon-cart",E.addEventListener("click",()=>{se(n._id)});const V=document.createElement("i");return V.className="fas fa-plus",h.append(_),x.append(F),E.append(V),n.quantity>1&&(l.append(g),f.append(h)),m.append(l),m.append(p),f.append(x),f.append(E),r.append(m),r.append(v),r.append(f),c.append(i),o.append(c),o.append(r),Q.innerText="Total "+k(t).toString(),L.innerText="Pagar",L.classList.remove("disabled"),C==null?void 0:C.append(o)})}L.addEventListener("click",()=>{I("user")?Te():(alert("Registrese o inicie sesión para completar la venta"),Ce.click())});let u=[];const Pe=document.querySelector("#cartContainer");function M(){u=b("carrito"),B(u),u.forEach(e=>{e!=null&&e._id&&A(e._id,!0)})}function se(e){u.find(t=>t._id===e)==null?u=[...u,{_id:e,quantity:1}]:u.map(t=>t._id===e?(t.quantity+=1,{...t,quantity:t.quantity}):t),B(u),A(e,!0)}function De(e){var t;((t=u.find(a=>a._id===e))==null?void 0:t.quantity)===1?(u=u.filter(a=>a._id!==e),A(e,!1)):u.map(a=>a._id===e?(a.quantity-=1,{...a,quantity:a.quantity}):a),B(u)}function Ae(e){u=u.filter(t=>t._id!==e),B(u),A(e,!1)}function A(e,t){const a=document.querySelector("#icon"+e);t?a.className="fas fa-check-circle ms-1":a.className="fa-solid fa-shopping-cart"}function B(e){Pe.innerHTML="",Me(e),T("carrito",e)}function oe(){return window.scrollTo({top:0,behavior:"smooth"}),document.getElementById("main-content").innerHTML+=`
  <div id="about">
      ...
      </div>`}function Be(e){const t=[];for(let a=1;a<=5;a++)e>=a?t.push("fas fa-star"):e>=a-.5?t.push("fas fa-star-half-alt"):t.push("far fa-star");return t.map(a=>`<i class="${a}"></i>`).join("")}function ie({_id:e,name:t,image:a,price:n,rating:s}){const o=document.querySelector("#activateCart"),c=()=>{se(e),o.click()},i=`
    <div class="col">
      <div class="card">
  ...
  `,r=document.createElement("div");r.innerHTML=i;const m=r.querySelector(`#addToCartButton${e}`);return m==null||m.addEventListener("click",c),r.firstElementChild}function ce({_id:e,name:t,image:a,description:n}){return document.getElementById("productModal").innerHTML+=`
  <div class="modal fade" id="staticBackdrop${e}" key="${e}" >
    ...
    </section>`,Re()}function Re(){const e=D,t=document.getElementById("productSection");e.forEach(a=>{const n=ie(a);ce(a),t==null||t.appendChild(n)})}function $e(){return document.getElementById("main-content").innerHTML+=`
    <!-- Galery products -->
    <section>
      <div class="products" name="product-section" id="product-section">
        <div class="container-xxl p-3 my-3">
    ...
    </section>`,je()}function je(){const e=D,t=document.getElementById("productSection");e.forEach(a=>{const n=ie(a);ce(a),t==null||t.appendChild(n)})}function He(){const e=document.getElementById("main-content"),t=document.querySelectorAll(".nav-menu");function a(){Y(),b("carrito")&&M()}function n(){oe()}function s(){$e(),b("carrito")&&M()}function o(i){e.innerHTML="",i()}function c(i){switch(i.preventDefault(),i.currentTarget.getAttribute("href").substring(1)){case"homePage":o(a);break;case"aboutPage":o(n);break;case"productPage":o(s);break}}t.forEach(i=>{i.addEventListener("click",c)}),o(Y)}function Ue(){return document.getElementById("loginModalSection").innerHTML+=`<div class="modal fade login-modal" id="loginModal">
  ...
  </div>`}Ue();const H=document.querySelector("#registerForm"),re=H.username,le=document.querySelector("#loginButton"),de=document.querySelector("#registerButton"),U=document.querySelector("#activeBtnLogin"),O=document.querySelector("#activeBtnRegister"),ue=document.querySelector("#modalTitle");function Oe(){U.addEventListener("click",Fe)}function _e(){O.addEventListener("click",Ve)}function Fe(){re.classList.add("visually-hidden"),de.classList.add("visually-hidden"),U.classList.add("visually-hidden"),le.classList.remove("visually-hidden"),O.classList.remove("visually-hidden"),ue.innerText="Iniciar sesión",H.classList.remove("was-validated")}function Ve(){re.classList.remove("visually-hidden"),de.classList.remove("visually-hidden"),U.classList.remove("visually-hidden"),le.classList.add("visually-hidden"),O.classList.add("visually-hidden"),ue.innerText="Registro",H.classList.add("was-validated")}let q=[],Je=[],w;const R=document.querySelector("#registerForm"),ze=R.username,y=R.email,P=R.password,Ge=document.querySelector("#loginButton"),Ke=document.querySelector("#registerButton"),Qe=document.querySelector("#formModalClose");function Z(){q=b("users")}Oe();_e();Ke.addEventListener("click",async e=>{if(e.preventDefault(),q.find(t=>t.email===y.value))alert("La cuenta ya está registrada");else if(R.checkValidity()){const t=await $(y.value,P.value),a=await $(P.value,JSON.stringify({email:y.value,username:ze.value,_id:t,purchase:Je}));We(a)}});Ge.addEventListener("click",e=>{e.preventDefault();const t=q.find(a=>a.email===y.value);t?me(P.value,t.user):alert(y.value+" no registrada")});function We(e){let t=ne();q.push({_id:t,email:y.value,user:e}),T("users",q),me(P.value,e)}async function me(e,t){try{w=JSON.parse(await ae(e,t)),w&&(ee("user",w),alert("Bienvenido "+w.username),Qe.click(),j(w))}catch{alert("Usuario y/o contraseña incorrectas")}}const Ye=document.querySelector("#activateProfile"),Ze=document.querySelector("#activateCart"),Xe=document.querySelector("#nav-home-tab"),X=document.querySelector("#nav-profile-tab");function et(){Ye.addEventListener("click",()=>{X.click()}),X.addEventListener("click",()=>{b("users")&&Z(),I("user")&&j(I("user"))}),Ze.addEventListener("click",()=>{Xe.click(),b("users")&&Z()})}const tt=document.querySelector("#loaderSection");document.addEventListener("DOMContentLoaded",()=>{He(),b("carrito")&&M(),et()});window.onload=()=>{tt.setAttribute("style","visibility:hidden; opacity:0;"),oe()};
